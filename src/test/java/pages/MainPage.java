...
public class MainPage {
    ...
    // languageText = $(byText("Создаем в России лучшие мировые технологии."));
    ...
    // Проверяем наличие таба BFS devices
    ...
    // Нажимаем чекбокс принятия политики в форме обратной связи
    public MainPage checkboxIsChecked() {
        privacyCheckbox.click();
        return this;
    }

    // Нажать кнопку для отправки формы
    public MainPage submitButtonClick() {
        submitButton.shouldBe(visible).click();
        return this;
    }

    // Проверить наличие валидации на форме обратной связи
    public MainPage checkValidationSubmitForm() {
        validationError.shouldBe(visible);
        return this;
    }

    //Проверить переход на английскую версию
